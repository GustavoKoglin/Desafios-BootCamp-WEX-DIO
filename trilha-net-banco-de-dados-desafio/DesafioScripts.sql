...
--Busca pelo filme de volta para o futuro, trazendo o nome, ano e a dura��o
SELECT
	Nome,
	Ano,
	Duracao
...
--Busca pelos filmes lan�ados em 1997
SELECT
	Nome,
	Ano,
	Duracao
...
--Busca os filmes lan�ados AP�S o ano 2000 com ordena��o por ano.
SELECT 
    Nome,
    Ano,
    Duracao
...
--Busca a quantidade de filmes lan�adas no ano, agrupando por ano, ordenando pela duracao em ordem decrescente, dizendo em um CASE quantos filmes teve no ano
SELECT
    Ano,
    COUNT(*) AS Quantidade,
    CASE 
...
--Busca os Atores do g�nero masculino, retornando o PrimeiroNome, UltimoNome
SELECT
    PrimeiroNome,
    UltimoNome
FROM Atores
...
--Busca as Atrizes (G�nero Feminino), retornando o PrimeiroNome, UltimoNome, e ordenando pelo PrimeiroNome
SELECT
    PrimeiroNome,
    UltimoNome
FROM Atores
...
--Busca o nome do filme e o g�nero, com o Genero em Ordem Crescente
SELECT
    f.Nome AS Filme,
    g.Genero
FROM Filmes f
...
--Busca o nome do filme e os atores, trazendo o PrimeiroNome, UltimoNome, seu Papel. Adicionais: Ano, Dura��o(min), G�nero do Ator.
SELECT
    f.Nome AS Filme,
    a.PrimeiroNome,
    a.UltimoNome,
